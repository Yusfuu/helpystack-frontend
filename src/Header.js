          ...
          <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:block sm:ml-6">
              <div className="flex space-x-4">
                ...
                <a href="/" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Thread</a>
              </div>
            </div>
          </div>
            ...
            <div className="ml-3 relative">
              <div>
                <button type="button"
                  ...
                  {/* 'https://img.icons8.com/fluency/96/000000/cat-profile.png' */}
                  <Avatar avatar={true} />
                </button>
              </div>
              ...
              <div id="menu" style={{ display: 'none' }}
                ...
                <span style={{ cursor: 'pointer' }} className="block px-4 py-2 text-sm text-gray-700" id="user-menu-item">Sign out</span>
              </div>
            </div>
          </div>
        </div>
